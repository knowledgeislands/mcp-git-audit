 ...
 * credential-bearing remote/clone URL can never reach the audit log verbatim.
 * Only the authority userinfo after `scheme://` is matched — scp-style
 * `git@host:path` (no `//`) and bare `@mentions` are left untouched.
 */
